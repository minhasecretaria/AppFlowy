        ...
        return result.fold(
          (info) {
            ...
            final updatedInfo = info.rebuild((value) {
              ...
              value.planSubscription = value.planSubscription.rebuild(
                (subscription) {
                  subscription.status = WorkspaceSubscriptionStatusPB.Active;
                  subscription.subscriptionPlan = SubscriptionPlanPB.Team;
                },
              );
            });
